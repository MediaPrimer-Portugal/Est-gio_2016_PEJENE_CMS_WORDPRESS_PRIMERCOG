...
<div class="bs_container">
    ...
    <form method="post" action="/wp-admin/admin-post.php">
        ...
        <div class="col-100">
            <h1 class="bs_title"><?php echo $_GET['id'] ? 'Edit Form' : 'Create Form'; ?></h1>

            <p class="bs_text"><?php echo $_GET['id'] ? $edit_str : $new_str; ?></p>
        </div>
                ...
                <div class="col-3">
                    <div class="panel">
                        ...
                        <div>
                            ...
                            <button type="button" class="button button-block fielditem addtext" data-type="1">Text</button>
                            <button type="button" class="button button-block fielditem addtext" data-type="4">Number</button>
                            <button type="button" class="button button-block fielditem addtext" data-type="5">Email</button>
                            <button type="button" class="button button-block fielditem addtext" data-type="2">Text Area</button>
                            <button type="button" class="button button-block fielditem addtext" data-type="3">Select</button>
                        </div>

                        <div>
                            <h4>Security</h4>
                            <button type="button" class="button button-block fielditem addtext" data-type="99">reCaptcha</button>
                        </div>

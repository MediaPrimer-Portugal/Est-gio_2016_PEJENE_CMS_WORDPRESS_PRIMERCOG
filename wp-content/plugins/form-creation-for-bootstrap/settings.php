                    ...
                    <div id="mail">
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="regular-text" name="settings[mail][primary_email]" value="<?php echo $settings['mail']['primary_email']; ?>">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="regular-text" name="settings[mail][header_image_url]" value="<?php echo $settings['mail']['header_image_url']; ?>">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                    $content = $settings['mail']['footer_text'];
                                    ...
                                    wp_editor($content, 'settings[mail][footer_text]', $editorSettings);
                                    ?>

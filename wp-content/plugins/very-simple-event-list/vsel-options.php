...
function vsel_admin_init() {
	...
	add_settings_field( 'vsel-field-7', __( 'Image and info', 'very-simple-event-list' ), 'vsel_field_callback_7', 'vsel', 'vsel-section-2' );
...
function vsel_field_callback_9() {
	...
	<label><input type='checkbox' name='vsel-setting-9' <?php checked( $value, 'yes' ); ?> value='yes'> <?php _e( 'Link title to the single event page.', 'very-simple-event-list' ); ?></label>
	<?php
}
